...
template_1 = lambda obj_1, obj_2: f"There is an object behind a {obj_1['shape']} in front of a {obj_2['shape']}, what color is it?" # 2nd
template_2 = lambda obj_1, obj_2: f"There is an object behind a {obj_1['shape']} in front of a {obj_2['shape']}, what shape is it?" # 2nd
template_3 = lambda obj_1, obj_2: f"There is an object behind a {obj_1['shape']} in front of a {obj_2['shape']}, what color is it?" # 3rd
template_4 = lambda obj_1, obj_2: f"There is an object behind a {obj_1['shape']} in front of a {obj_2['shape']}, what shape is it?" # 3rd
